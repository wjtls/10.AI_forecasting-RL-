...
## 4. 결과
   ...
   - 800 스탭이후부터 각 loss가 수렴하기 시작하고 PV 및 reward도 수렴을 시작한다
     <br/><br/><br/>
## 5. 테스트 셋 예측 (AI가 학습하지않은 2년 구간의 여러 데이터 실험)<br/>
   - 과소,과대 적합을 판단하기에 val, test 구간으로 나누고 한스탭씩 도출하는 전진 테스트를 진행하는 방안도 있으며 동일업종에서 다른 종목의 가격 (ex S&P500의 가격 예측시 nasdaq100 또는 Dow 등)을 활용한 테스트 방안도 있다.
   ![image](https://github.com/wjtls/10.AI_forecasting-RL-/assets/60399060/9b27cb4f-4f4a-4099-817d-159cb9041d68)<br/>
   - 우측 그림 POWR가격 에서 AI모델이 5000스탭 부근 급격한 변동이 있는 구간의 하락을 예상하고 대처 행동을 도출하여 대응한다.
   - 좌측 그림에서는 전체 추세를 예측하는 모습이며 최근 상승이후 횡보또는 하락할것을 예상하고 있다. (2024.4 기준 실제로 추세 횡보 및 하락중)
   - POWR 예측 스코어는 초기 수치 1000점 대비  1824.4166259765625점을 달성한다. (방향 및 예측 성공 시간을 고려하여 스코어 책정한다, 즉 오랫동안 방향을 잘 예측해야 스코어를 높게 받는구조)
   ![image](https://github.com/wjtls/10.AI_forecasting-RL-/assets/60399060/da8cbea0-aae7-46d9-a8d2-57979db675f4)
   - XRP 예측 스코어는 초기 수치 1000점 대비 1230.0289306640625로 전체적인 추세를 예측한다 
