...
## 5. 테스트 셋 예측 (AI가 학습하지않은 2년 구간의 여러 데이터 실험)<br/>
   - 과소,과대 적합을 판단하기에 val, test 구간으로 나누고 한스탭씩 도출하는 전진 테스트를 진행하는 방안이 있지만 동일업종에서 다른 종목의 가격 (ex S&P500의 가격 예측시 nasdaq100 또는 Dow 등)을 활용한 테스트 방안도 있다.
   ...
   - POWR 예측 스코어는 초기 수치 1000점 대비 1101점을 달성한다.
